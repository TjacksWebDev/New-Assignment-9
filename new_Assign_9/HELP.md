...
* The original package name 'com.coderscampus.Assignment 9' is invalid and this project uses 'com.coderscampus.Assignment9' instead.
...
```
$ docker run --rm -p 8080:8080 Assignment-9:0.0.1-SNAPSHOT
```
